...
<form id="patientForm" class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <small class="form-text">Nombres del paciente</small>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <small class="form-text">Apellidos del paciente</small>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="identification_number" class="form-label required">Número de Identificación</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="date_of_birth" class="form-label required">Fecha de Nacimiento</label>
                    <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" required max="{{ date('Y-m-d') }}">
...
function validateForm(data) {
    ...
    const requiredFields = ['first_name', 'last_name', 'identification_number', 'date_of_birth', 'gender'];
    ...
    if (data.date_of_birth) {
        ...
        if (birthDate > today) {
            showFieldError('date_of_birth', 'La fecha de nacimiento no puede ser futura');
            isValid = false;
        }
        
        const age = today.getFullYear() - birthDate.getFullYear();
        if (age > 150) {
            showFieldError('date_of_birth', 'Por favor verifique la fecha de nacimiento');
            isValid = false;
        }
    }
