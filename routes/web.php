...
Route::middleware('auth:web')->group(function () {
    ...
    // RUTA TEMPORAL: Crear relaciones médico-paciente faltantes
    Route::get('/api/fix-doctor-patient-relationships', function() {
        try {
            $created1 = 0;
            $created2 = 0;
            ...
            return response()->json([
                'success' => true,
                'message' => 'Relaciones médico-paciente creadas exitosamente',
                'data' => [
                    'relaciones_desde_creadores' => $created1,
                    'relaciones_desde_citas' => $created2,
                    'total_relaciones_en_bd' => $totalRelations
                ]
            ]);
